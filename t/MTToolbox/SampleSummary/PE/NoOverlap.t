...
BEGIN { use_ok( 'MTToolbox::SampleSummary::PE::NoOverlap'); }

### Create a MTToolbox::SampleSummary::PE::NoOverlap object to test
my $ssi = MTToolbox::SampleSummary::PE::NoOverlap->new();

# set some values -- these are also tested in the parent class
is( $ssi->set_sample_name('sample1'), 1, "set_sample_name()" );
